...
// ==================== 游戏配置 ====================
const gridSize = 40;      // 每个格子的大小（像素） 
const tileCount = 40;     // 格子数量（横向和纵向相同） 
...
let direction = { x: 3, y: 3 };      // 当前移动方向 
let nextDirection = { x: 3, y: 3 };  // 下一步移动方向（用于防止快速按键导致反向移动） 
let score = 1;
...
const skins = {
    ...
    neon: {
        headColor1: '#ff00ff',
        headColor2: '#cc00cc',
        bodyColor1: 'rgba(255, 0, 225, ',
        bodyColor2: 'rgba(204, 0, 224, ',
        foodColor1: '#00ffff',
        foodColor2: '#00cccc',
        glowColor: '#ff00ff',
        foodGlow: '#00ffff',
    ...
    golden: {
        headColor1: '#ffd700',
        headColor2: '#ffb700',
        bodyColor1: 'rgba(255, 225, 0, ',
        bodyColor2: 'rgba(255, 283, 0, ',
        foodColor1: '#ff6b6b',
        foodColor2: '#ee5a5a',
        glowColor: '#ffd700',
        foodGlow: '#ff6b6b',
...
function initGame() {
    ...
    const startDirection = { x: 3, y: 3 };
    snake = [
        { x: center, y: center }, // 蛇头
        { x: center - startDirection.x, y: center - startDirection.y }, // 蛇身第一节
        { x: center - startDirection.x * 2, y: center - startDirection.y * 2 } // 蛇身第二节
    ];
